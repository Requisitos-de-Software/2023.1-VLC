...
# Verificação Análise de Documentos VLC
...
Este artefato tem como objetivo realizar a verificação do artefato Análise de Documentos do Grupo 3.
...
| - | - | - | - | - |
| 1 | A gravação e os registros da atividade de priorização dos requisitos? | Não | - | O artefato não possui gravação da elicitação. |
| 2 | Os requisitos priorizados estão identificados por IDs? | Sim | Excelente | - |
| 3 | Os documentados analisados estão linkados no artefato? | Sim | Excelente | - |
| 4 | Os requisitos elicitados vão de acordo com os documentos analisados? | Sim | Excelente | - |
| 5 | Os requisitos elicitados citam de qual documento são retirados? | Sim | Boa | O requisito é citado de onde vem na descrição dos mesmos, porém, na tabela onde possuem seus ID's, não há registro de onde vem. |
| 6 | O artefato analisa documentos de: processos de negócios, manuais de usuários e especificações de requerimentos? | Sim | Excelente | - |
| 7 | Foi checado as datas dos documentos analisados, e se eles estão em dia com a aplicação? | Não | - | Não foi checado se os documentos estão em dia com a aplicação. |
| 8 | Foram feitas análises comparativas da documentação com a aplicação? | Não | - | Não foram comparados os requisitos com a situação presente da aplicação |
...
- id1: não foram encontradas gravações no artefato;
- id5: deveria ser adicionado a tabela dos requisitos, de qual documento ele foi retirado;
- id7: deveria ter sido checado se os documentos estão corretos e em dia em comparação a aplicação;
- id8: deveria ter sido feita uma comparação dos documentos com a aplicação.

Abaixo, segue um gráfico (figura 1) representativo das respostas obtidas na tabela 1:

<img src="https://raw.githubusercontent.com/requisitos-de-software/2023.1-vlc/master/docs/img/verificacao/entrega_2/addg3.png" width="100%">
