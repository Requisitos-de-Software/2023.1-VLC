...
## Conteúdo esperado
<div align="justify">
<p>É esperado que o artefato apresente as ferramentas que foram utilizadas para o desenvolvimento do projeto.</p>
</div>
...
<p>A Tabela 1 apresenta as perguntas realizadas pelo <a href="https://github.com/Requisitos-de-Software/2023.1-Booking">Grupo 2</a> no documento <a href="https://github.com/Requisitos-de-Software/2023.1-Booking/blob/main/docs/verificacao3/planejamento/ferramenta.md">Verificação das Ferramentas</a>[2], quanto a respeito da formatação dos artefatos.
...
| 6 | As tabelas e imagens possuem legenda, fonte e são introduzidas no texto? | Sim | Incompleto | Tabela 1 não está sendo chamada. |
| 7 | A artefato possui autor? | Sim | Excelente | --- |
| 8 | A artefato possui revisor? | Sim | Excelente | --- |

<b>Tabela 1</b>: perguntas retiradas de <a href="https://github.com/Requisitos-de-Software/2023.1-Booking">Grupo 2</a> (Fonte: <a href="https://github.com/Requisitos-de-Software/2023.1-Booking/blob/main/docs/verificacao3/planejamento/ferramenta.md">Verificação Ferramentas Grupo 3</a>. 2023).

<p><b>Tabela 2</b>: Relação das perguntas quanto ao conteúdo do artefato realizadas pelo integrante do grupo 3</p>

| ID | Conteúdo | Possue | Qualidade | Observação |
| - | - | - | - | - |
| 9 | O referencial dos aplicativos citados está correto? | Não | --- | Foi citado que as ferramentas seriam utilizadas para desenvolver os requisitos do aplicativo WebDiet. |
| 10 | O artefato apresenta imagens para ilustrar as aolicativos? | Sim | Excelente | --- |
| 11 | Foi dado uma breve descrição da motivação de utilizar tal aplicativo? | Sim | Excelente | --- |
| 12 | Todas as ferramentas utilizadas para desenvolver o projeto foram citadas? | Sim | Incompleto | Falta citas as ferramentas de prototipação e análise que foram utilizadas. |
| 13 | Todas os nomes e logos das ferramentas condizem com o pesquisado sobre elas? | Sim | Incompleto | A logo da ferramenta discord está errada. |

<b>Tabela 2</b>: Relação das perguntas quanto ao conteúdo do artefato (Fonte: SANTOS, MIZAEL. 2023).

<img src=https://raw.githubusercontent.com/requisitos-de-software/2023.1-vlc/master/docs/img/verificacao/entrega_1/ferramentas.png>
<b>Imagem 1</b>: Grafico  dos cronograma (Fonte: SANTOS, Mizael. 2023).


### Conclusão
<div align="justify">
<p>A respeito da estrutura foi encontrado apenas um problema, ademais apenas erros de atualização das ferramentas utilizadas e suas logos.</p>
<h3><p><b>6</b> - As tabelas e imagens possuem legenda, fonte e são introduzidas no texto?</p></h3>
<p> Tabela 1 não está sendo chamada.</p>
<h3><p><b>9</b> - O referencial dos aplicativos citados está correto?</p></h3>
<p>É citado o aplicativo WebDiet, porém ele não foi utilizado.</p>
<h3><p><b>12</b> - Todas as ferramentas utilizadas para desenvolver o projeto foram citadas?</p></h3>
<p>Falta citas as ferramentas de prototipação e análise que foram utilizadas.</p>
<h3><p><b>13</b> - Todas os nomes e logos das ferramentas condizem com o pesquisado sobre elas?</p></h3>
<p> Não, a logo do discord está errada.</p>
</div>
...
<ul>
<li> Citar a Tabela 1. 
<li> Atualizar a introdução, retirando a citação ao aplicativo webdiet.
<li> Arrumar a logo da ferramenta Discord.
<li> Adicionar ferramentas como o Figma e o VLC, que foi utilizado para estudo.
</ul>
</div>
