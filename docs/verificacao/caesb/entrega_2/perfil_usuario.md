...
# Verificação do perfil de usuário do Grupo 4 (Caesb)
...
| - | - | - | - | - |
| 1 | Dados demográficos: idade, sexo, status socioeconômico; | Sim | Excelente | Faltou apenas o sexo dos participantes |
| 2 | Cargo que ocupa:  | Sim | Incompleta | A pergunta foi feita, mas não se tem no documento a resposta |
| 3 | Educação: | Sim | Boa | Poderia estar mais completos com dados sobre a frequencia de leitura entre outros aspectos |
| 4 | Experiência com um produto específico ou ferramentas semelhantes? | Sim | Excelente | Existe a pergunta e a resposta relacionada |
| 5 | Foi agrupado os usuários com características semelhantes? | Sim | Excelente |  |
...
- id 8, o grupo 4 pecou em utilizar apenas uma técnica para coleta de dados, o que pode prejudicar a vericidade dos dados.

Abaixo, segue um gráfico (figura 1) representativo das respostas obtidas na tabela 1:

<img src="https://raw.githubusercontent.com/requisitos-de-software/2023.1-vlc/master/docs/img/verificacao/entrega_2/perfilusu.jpeg" width="100%">
...
- Documento do Perfil de usuário do Grupo 4 da Disciplina de Requisitos. Disponível em: https://requisitos-de-software.github.io/2023.1-Caesb/Elicitacao/perfil_usuario/ Acesso em: 03 jun. 2023.
